...
Building the client project to create the types in the `ApiGateway` namespace. The `Order` types are generated by the gRPC framework automatically by the build process.

Create a new file in the `Controllers Folder` called `OrderController.cs`.
